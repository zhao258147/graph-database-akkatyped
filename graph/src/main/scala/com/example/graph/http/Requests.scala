...
object Requests {
  ...
  case class UpdateEdgeReq(targetNodeId: String, edgeType: String, direction: String = "to", userId: String, properties: EdgeProperties = Map.empty, userLabels: Map[String, Int] = Map.empty)
  ...
  case class TrendingNodesReq(types: List[String])
}
